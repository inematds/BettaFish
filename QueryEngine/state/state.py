...
@dataclass
class Search:
    """Estado de um resultado de busca individual"""
...
class Paragraph:
    ...
    def is_completed(self) -> bool:
        """Verificar se o parágrafo está concluído"""
...
class State:
    ...
    is_completed: bool = False                                     # Se está concluído
