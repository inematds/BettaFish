...
class LLMClient:
    ...
    def stream_invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> Generator[str, None, None]:
        """
        Chamada em streaming ao LLM, retornando o conteúdo da resposta progressivamente
        ...
        try:
            ...
            logger.error(f"Falha na requisição em streaming: {str(e)}")
            raise e

    @with_retry(LLM_RETRY_CONFIG)
    def stream_invoke_to_string(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        """
        Chamada em streaming ao LLM, concatenando com segurança em string completa (evitando truncamento de caracteres UTF-8 multibyte)
