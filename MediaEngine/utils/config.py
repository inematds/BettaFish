...
class Settings(BaseSettings):
    ...
    SEARCH_TOOL_TYPE: Literal["TavilyAPI", "AnspireAPI", "BochaAPI"] = Field("TavilyAPI", description="Tipo de ferramenta de busca na web. Suporta TavilyAPI, BochaAPI ou AnspireAPI. Padrão: TavilyAPI")
